...
//           // careerMatches: backend returns array of { title, sub, pct }
...
//               {/* ── 1. Learning path progress (REAL: from career backend skills array) ── */}
...
//               {/* ── 3. AI career suggestion (REAL: from career backend careerMatches array) ── */}
//               <div style={{ ...card, transition: 'background 0.3s, border 0.3s' }}>
...
//               {/* ── 4. Weekly activity chart (REAL: from progress backend) ── */}
//               <div style={{ ...card, transition: 'background 0.3s, border 0.3s' }}>
